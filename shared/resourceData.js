export const RESOURCEDATA = [
    ...
    },
    {
        ...
        important: "Learning to crochet can seem dauting at first with all the new terminology, stitch types, and trying to read patterns. Books aimed at novice crocheters can help to clarify understanding by presenting the needed information in a cronological, succint, and simple manner. Books also act as a great reference thoughout one's crochet journey by acting as a knowledge store and keeping crocheters from having to memeorize large amounts of infomration they use rarely.  ", 
        content: "\nSome of the most popular books for those just starting to crochet include:\n\nA to Z of Crochet\nThis books starts at the very beginning level (i.e. is yarn that stringy thing and what in the world is a crochet hook?!) and walks readers step through step. This book is mainly information though, and does not contain any patterns. It is a good reference even for expereinced crocheters.\n\nCrochet Techniques & Tips\nA much beloved guide filled with techniques, tips, and tricks explained clearly and with pictures. This book does contain information and instructions and staple stitches in every crocheters' corner. Many novice crocheters appreciate the books streight-to-the-point manner.\n\nCrochet For Beginners: A Complete Step By Step Guide With Pictures Illustrations To Learn Crocheting The Quick And Easy Way\nIf you are just starting out your crochet journey and are left handed, you will quickly find out the instructions and patterns are a bit different for you. This book contains a large section dedicated to just left-handed crocheters where others gloss over or ignore them. There are both drawings and pictures to accompany instructions and contain some patterns. This book would be best for a crocheter who has a basic knowledge of terminology and are looking to improve.\n\nThe Complete Book Of Crochet Stitch Designs: 500 Classical & Orginal Patterns\nThis book is a perfect reference guide for crocheters looking to get into more advanced stitches and designs. Each stitch comes with photo diagrams, written instructions, and use colored yarn for easy visuals. There is also information in terminology and symbols that are common in more advanced crochet. Even basic stitches are included in this book and ensure readers have a solid foundation of knowledge."
    },
    {
        id: 3, 
        title: "Where To Insert Your Hook", 
        important: "Deciding where to insert your hook has a big impact in how the resulting crochet work turns out. In some cases, pattern writers even specify where to insert one's hook.", 
        content: "\nThere are three main locations where you can insert your hook: back of the loop, front of the loop, or top of the stitch. Between stitches and post are two of the less common hook insertion points and beginners do not have to worry about those till later in their journey\n\nInserting at the top of the stitch is the default insertion location to the point where if pattern writiers don't specify a location you should assume they mean the top. You can tell the top of a stitch by looking at the top of your first row. The top of a stitch makes a '>' shape. If the stitches happen to make a '<' shape you will need to turn your work to the other side. To insert your hook through the top of a stitch, simply insert underneath the two sides of the '>' shape.\n\nLooking at the top of a stitch also helps you to tell where the front and back loops are. When looking at the stitch correctly, the front loop is the bit of stitch closest to you while the back loop is the bit of stitch farthest away from you. To insert your hook into the front loop simply insert under the front loop (disreguard the back loop) and continue on with your stitch. To insert under the back loop do the opposite; disreguard the front loop and simply insert underneath the back loop before continuting the stitch."
    }, 
    {
        id: 4, 
    ...
    }, 
    {
        id: 16, 
        title: "Amigurumi", 
        important: "Amigurumi is a fantastic next-step in any crochet journey if one wishes to begin challenging themselves. These figures are cute, perfect for gift giving, and enjoyable to make. THey allow crocheters to practice pattern reading, many different stitches, and a variety of other skills adn techniques.", 
        content: "\nAmigurumi comes from the Japanese terms ami and nuigurumi, ami meaning crocheted or knitted and nuigurumi meaning a stuffed doll. These figures are 3D stuffed creations that tend to be animals or fantasical creatures (though human figures are common too). Besides yarn and a crochet hook, one will also need a yarn needle, possibly a double npointed needle, filling or stuffing, and any embelishments one desires (e.g. plastic safety eyes). Before you begin your Amigurumi jounrey, get some practice in working small diameters into the round, increasing and decreasing, sewing crocheted pieces together, and reading crochet patterns, charts, or graphs."
    }, 
    {
        id: 17, 
